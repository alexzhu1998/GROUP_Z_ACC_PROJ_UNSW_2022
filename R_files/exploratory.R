...
keep_goal <- c('Age','Playing_Time_90s','Performance_GA90','Performance_Save%',
               'W','D','L','Performance_CS','Performance_CS%','Penalty_Kicks_PKA',
               'Penalty_Kicks_PKsv','Penalty_Kicks_Save%','Annualized_Salary')
#Player cormat
